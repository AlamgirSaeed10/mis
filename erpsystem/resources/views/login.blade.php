            ...
            <div class="row justify-content-center ">
               <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="p-2 ">
                           <form class="form-horizontal" action="{{URL('/UserVerify')}}" method="post">
                              ...
                              <div class="mb-3">
                                 ...
                                 <input type="text" name="EmailOffical" value="kashif.mushtaq20@gmail.com" class="form-control" id="EmailOffical" placeholder="Enter Offical email" value="{{old('EmailOffical')}}">
                              </div>
                              <div class="mb-3">
                                 <label class="form-label">Password</label>
                                 <div class="input-group auth-pass-inputgroup">
                                    <input name="Password" type="password" value="123456" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" value="{{old('password')}}">
                  ...
                  <div class="mt-5 text-center">
                     <div>
                        <p>
                           Copyright &copy <script>document.write(new Date().getFullYear())</script> HR Extensive System. All rights reserved
                        </p>
                     </div>
                  </div>
               </div>
