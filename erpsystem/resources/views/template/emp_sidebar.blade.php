                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                    	...
                                    	<ul class="list-unstyled categories-list">
                                                          <li>
                                                            <a href="{{URL('/EmployeeDetail')}}" class="text-body d-flex align-items-center">
                                                        ...
                                                        <li>
                                                            <a href="{{URL('/EmployeeDocuments')}}" class="text-body d-flex align-items-center">
 ...
 font-size-16 me-2"></i> <span class="me-auto">Leave</span> <i class="mdi mdi-circle-medium text-danger ms-2"></i>
                                                        ...
                                                        <li>
                                                            <a href="{{URL('/EmployeeAttendance')}}" class="text-body d-flex align-items-center">
                                                                <i class="mdi mdi-fingerprint
 text-muted font-size-18 me-2"></i> <span class="me-auto">Attendance</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{URL('/EmployeeWarningLeter')}}" class="text-body d-flex align-items-center">
 ...
 text-muted font-size-18 me-2"></i> <span class="me-auto">Warnings</span>
                                                        ...
                                                        <li>
                                                            <a href="{{URL('/EmployeeFCB')}}" class="text-body d-flex align-items-center">
