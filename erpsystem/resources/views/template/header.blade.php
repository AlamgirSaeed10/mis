        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{URL('/dashboard')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{URL('/')}}/assets/images/icon-hr.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="{{URL('/dashboard')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{URL('/')}}/assets/images/icon-hr.png" alt="" height="19">
                    </span>
                    <span class="logo-lg">
                        <img src="{{URL('/')}}/assets/images/logo-light.png" alt="" height="45">
                    </span>
                </a>
            </div>
