                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{-- <input id="input-mask" type="text" class="form-control input-mask"
                                            data-inputmask="'mask': 'xxxxx-xxxxxxx-x'" im-insert="true" name="CNIC"
                                            required> --}}
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="DateOfBirth" class="form-control"
                                                value="{{ old('DateOfBirth') }}" im-insert="false" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4 ">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="VisaIssueDate" class="form-control input-mask"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="VisaExpiryDate" class="form-control input-mask"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3"><label for="basicpill-firstname-input" class="pr-5">Upload
                                                Staff Picture</label><br><input type="file" name="Uploadpicture"
                                                required></div>
                                    </div>
