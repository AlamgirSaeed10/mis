        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{route('letter_issue_save')}}" method="post">
                                {{csrf_field()}}
                                <div class="card">
                                    <div class="card-body">
                                        <input class="form-control" type="hidden" name="EmployeeID" id="example-email-input" required value="{{$employee[0]->EmployeeID}}">
