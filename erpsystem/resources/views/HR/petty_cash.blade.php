    ...
    <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div id="vhno_div"><img src="{{asset('assets/images/profile-img.png')}}" style="width: 20px;height:50px;" alt="">
                     </div>
                  </div>
                </div>
              </div>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChartOfAcc2[]" id="ItemID0_'+i+'" class="form-select form-control-sm">       </select></td>';
